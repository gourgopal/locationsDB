...
GO
CREATE TRIGGER [USR].[TRANSACTIONS_history_INSERT] on [USR].[TRANSACTIONS] FOR INSERT
AS
INSERT INTO [history].[TRANSACTIONS] ([TID], [AMOUNT], [TYPE], [UM_ID], history_type) select [TID], [AMOUNT], [TYPE], [UM_ID],  'IN' from INSERTED
GO
CREATE TRIGGER [USR].[TRANSACTIONS_history_UPDATE] on [USR].[TRANSACTIONS] FOR UPDATE
AS
INSERT INTO [history].[TRANSACTIONS] ([TID], [AMOUNT], [TYPE], [UM_ID], history_type) select [TID], [AMOUNT], [TYPE], [UM_ID], 'UP' from INSERTED
GO
CREATE TRIGGER [USR].[TRANSACTIONS_history_DELETE] on [USR].[TRANSACTIONS] FOR DELETE
AS
INSERT INTO [history].[TRANSACTIONS] ([TID], [AMOUNT], [TYPE], [UM_ID], history_type) select [TID], [AMOUNT], [TYPE], [UM_ID], 'DE' from DELETED
GO